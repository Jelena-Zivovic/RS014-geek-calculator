...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        stackedWidgets->setGeometry(QRect(150, 10, 521, 421));
        ...
        goToMatrixButton = new QPushButton(horizontalLayoutWidget);
        goToMatrixButton->setObjectName(QString::fromUtf8("goToMatrixButton"));

        horizontalBoxMainPage->addWidget(goToMatrixButton);

        stackedWidgets->addWidget(mainPage);
        matrixPage = new QWidget();
        matrixPage->setObjectName(QString::fromUtf8("matrixPage"));
        stackedWidgets->addWidget(matrixPage);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        goToMatrixButton->setText(QApplication::translate("MainWindow", "matrix", nullptr));
